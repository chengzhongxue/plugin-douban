                    ...
                    while (confition) {
                        ...
                        if (arrayNode.isEmpty()){
                            ...
                            for(JsonNode node : arrayNode){
                                ...
                                String doubanId = subject.get("id").asText();
                                ...
                                Predicate<DoubanMovie> predicate = doubanMovie -> doubanMovie.getSpec().getType().equals(type1) && doubanMovie.getSpec().getDoubanId().equals(doubanId);
                                ...
                                if (doubanMovies.size()==0){
                                    ...
                                    doubanMovie.getSpec().setDoubanId(doubanId);
                                    doubanMovie.getSpec().setDoubanScore(doubanScore);
                                    ...
                                    doubanMovie.getSpec().setTmdbType("db");
